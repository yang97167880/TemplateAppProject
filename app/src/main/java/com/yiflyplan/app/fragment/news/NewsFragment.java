...
package com.yiflyplan.app.fragment.news;
...
import com.yiflyplan.app.adapter.base.delegate.SingleDelegateAdapter;
...
//        RecyclerViewHolder
        ...
        SimpleDelegateAdapter<AdapterItem> commonAdapter = new SimpleDelegateAdapter<AdapterItem>(R.layout.adapter_common_grid_item, gridLayoutHelper, DemoDataProvider.getGridItems(getContext())) {
            @Override
            protected void bindData(@NotNull @NonNull MyRecyclerViewHolder holder, int position, AdapterItem item) {
                if (item != null) {
                    RadiusImageView imageView = (RadiusImageView) holder.findViewById(R.id.riv_item);
        ...
        //资讯
        mNewsAdapter = new BroccoliSimpleDelegateAdapter<NewInfo>(R.layout.adapter_news_card_view_list_item, new LinearLayoutHelper(), DemoDataProvider.getEmptyInfo(NewInfo.class)) {
            @Override
            protected void onBindData(MyRecyclerViewHolder holder, NewInfo model, int position) {
                if (model != null) {
            ...
            @Override
            protected void bindData(@NotNull @NonNull MyRecyclerViewHolder holder, int position, NewInfo item) {
