...
@Page(name = "转移二维码")
public class ProductQRCode extends BaseFragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    protected void initListeners() {
        ...
        List<String> ids = (List<String>) build.getSerializable("ids");
