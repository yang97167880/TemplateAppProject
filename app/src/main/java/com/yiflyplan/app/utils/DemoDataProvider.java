...
import com.yiflyplan.app.adapter.entity.NewInfo;
...
public class DemoDataProvider {
    ...
    public static List<NoticeInfo> getDemoNoticeInfos() {
        ...
        infoList.add(new NoticeInfo("女朋友","icon_head_default","在吗？","21/2/14"));
        infoList.add(new NoticeInfo("老婆","icon_head_default","吃了吗？","21/2/14"));
        infoList.add(new NoticeInfo("闺蜜","icon_head_default","晚安。","21/2/14"));
        infoList.add(new NoticeInfo("老公","icon_head_default","口红好用吗？","21/2/14"));
        infoList.add(new NoticeInfo("男朋友","icon_head_default","我去洗澡啦？","21/2/14"));
        return infoList;
    }
    ...
    @MemoryCache
    public static List<OrganizationInfo> getDemoOrganizationInfos() {
        List<OrganizationInfo> infoList = new ArrayList<>();
        infoList.add(new OrganizationInfo("第一医院",R.drawable.ic_menu_organization));
        infoList.add(new OrganizationInfo("第二医院",R.drawable.ic_menu_organization));
        infoList.add(new OrganizationInfo("第三医院",R.drawable.ic_menu_organization));
        infoList.add(new OrganizationInfo("第四医院",R.drawable.ic_menu_organization));
        infoList.add(new OrganizationInfo("第五医院",R.drawable.ic_menu_organization));
        return infoList;
    }
