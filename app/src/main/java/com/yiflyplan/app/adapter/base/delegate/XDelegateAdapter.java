 ...
 */
public abstract class XDelegateAdapter<T, H extends RecyclerView.ViewHolder> extends DelegateAdapter.Adapter<H> {
    /**
     * 数据源
     */
     ...
     */
    @NonNull
    protected abstract H getViewHolder(@NonNull ViewGroup parent, int viewType) throws Exception;
     ...
     * @param item     列表项
     */
    protected abstract void bindData(@NonNull H holder, int position, T item);
