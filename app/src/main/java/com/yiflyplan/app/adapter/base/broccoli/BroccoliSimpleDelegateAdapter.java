...
import com.yiflyplan.app.adapter.base.delegate.XDelegateAdapter;
...
public abstract class BroccoliSimpleDelegateAdapter<T> extends SimpleDelegateAdapter<T> {
    ...
    @Override
    protected void bindData(@NotNull MyRecyclerViewHolder holder, int position, T item) {
     ...
     * @param position
     */
    protected abstract void onBindData(MyRecyclerViewHolder holder, T model, int position);
     ...
     * @param broccoli
     */
    protected abstract void onBindBroccoli(MyRecyclerViewHolder holder, Broccoli broccoli);
