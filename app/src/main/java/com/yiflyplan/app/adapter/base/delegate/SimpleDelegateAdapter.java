 ...
 */
public abstract class SimpleDelegateAdapter<T> extends BaseDelegateAdapter<T, MyRecyclerViewHolder> {
    ...
    public SimpleDelegateAdapter(int layoutId, LayoutHelper layoutHelper, Collection<T> list) {
        super(list, MyRecyclerViewHolder.class);
        mLayoutId = layoutId;
        mLayoutHelper = layoutHelper;
    }

    public SimpleDelegateAdapter(int layoutId, LayoutHelper layoutHelper, T[] data) {
        super(data, MyRecyclerViewHolder.class);
        mLayoutId = layoutId;
        mLayoutHelper = layoutHelper;
    }
